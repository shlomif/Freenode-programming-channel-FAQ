- [Freenode programming channel FAQ](#Freenode-programming-channel-FAQ)
...
- [How do I address someone to grab his/her attention?](#How-do-I-address-someone-to-grab-his-her-attention)
...
- [What is the channel for $TOPIC/$TECHNOLOGY?](#What-is-the-channel-for-TOPIC-TECHNOLOGY)
...
- [How should I do binary Input/Output properly?](#How-should-I-do-binary-Input-Output-properly)
...
- [I need/am forced to work with a certain technology (e.g: programming language or framework) which I hate. What should I do?](#I-need-am-forced-to-work-with-a-certain-technology-e-g-programming-language-or-framework-which-I-hate-What-should-I-do)
...
- [I feel like programming something, but I don't know what. Can you suggest some good ideas for programs?](#I-feel-like-programming-something-but-I-don-t-know-what-Can-you-suggest-some-good-ideas-for-programs)
...
- [I am facing a number of problems while using floating-point data types (e.g: "float" or "double"). Is there a explanation for this?](#I-am-facing-a-number-of-problems-while-using-floating-point-data-types-e-g-float-or-double-Is-there-a-explanation-for-this)
- [How do I hide/obscure/“encrypt” my source code to prevent end-users from learning how it works?](#How-do-I-hide-obscure-encrypt-my-source-code-to-prevent-end-users-from-learning-how-it-works)
- [Who is the world’s best programmer?](#Who-is-the-world-s-best-programmer)
- [I printed something but don't see it on the console yet! My output is out-of-order? Help!](#I-printed-something-but-don-t-see-it-on-the-console-yet-My-output-is-out-of-order-Help)
...
- [How can I learn Web Development? (HTML/etc.)?](#How-can-I-learn-Web-Development-HTML-etc)
...
- [Is {software dev paradigm, e.g: Object-Oriented Programming, Functional Programming, Structured Programming} bad/good/better/worse?](#Is-software-dev-paradigm-e-g-Object-Oriented-Programming-Functional-Programming-Structured-Programming-bad-good-better-worse)
...
- [Where can I learn to write and/or read regular expressions?](#Where-can-I-learn-to-write-and-or-read-regular-expressions)
...
- [I shared my code (using a paste-site/etc.) and people on the channel complained that my indentation is bad / off / inconsistent , but it looks fine in my text editor. Why?](#I-shared-my-code-using-a-paste-site-etc-and-people-on-the-channel-complained-that-my-indentation-is-bad-off-inconsistent-but-it-looks-fine-in-my-text-editor-Why)
...
- [How do I debug memory errors (e.g: crashes, memory leaks, double-freeing) in my C / etc. programs?](#How-do-I-debug-memory-errors-e-g-crashes-memory-leaks-double-freeing-in-my-C-etc-programs)
...
- [How is this symbol/character/punctuation mark called in English?](#How-is-this-symbol-character-punctuation-mark-called-in-English)
- [How do I find the size and/or length of an array in C?](#How-do-I-find-the-size-and-or-length-of-an-array-in-C)
...
- [Can a copyright owner change the licence of an open source project if they dislike someone's abuse of it?](#Can-a-copyright-owner-change-the-licence-of-an-open-source-project-if-they-dislike-someone-s-abuse-of-it)
...
- [This FAQ seems useful. Why isn't it in the channel's topic?](#This-FAQ-seems-useful-Why-isn-t-it-in-the-channel-s-topic)
...
that [“Reality to be conquered must be obeyed.”](http://shlomifishswiki.branchable.com/Self-Sufficiency/) and all that jazz, and try to cope with what you have.
